...
class SongController extends Controller
{
    ...
    public function store(StoreSongRequest $request)
    {
        try {
            ...
            return response()->json(['message' => 'Something went wrong in SongController.store', 'error'=>$e->getMessage()], 400);
        }
    ...
    public function destroy(int $id, int $user_id)
    {
        try {
            ...
            return response()->json(['message' => 'Something went wrong in SongController.destroy', 'error'=>$e->getMessage()], 400);
        }
    }
}
